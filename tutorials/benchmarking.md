...
<pre id="plutouiterminal">MethodInstance for Main.var\"workspace#4\".double(::Dict{Symbol, AbstractFloat}, ::Symbol)
  from double(�[90mmapping�[39m, �[90mkey�[39m::�[1mSymbol�[22m)�[90m @�[39m �[90mMain.var\"workspace#4\"�[39m �[90m~/work/Julia2/Julia2/tutorials/�[39m�[90m�[4mbenchmarking.jl#==#3f0e2049-8597-4dac-b499-4d7a8a35978e:1�[24m�[39m
Arguments
...
<pre id="plutouiterminal">BenchmarkTools.Trial: 10000 samples with 991 evaluations.
 Range (min … max):  41.368 ns … 596.785 ns  ┊ GC (min … max): 0.00% … 87.17%
 Time  (median):     42.451 ns               ┊ GC (median):    0.00%
 Time  (mean ± σ):   42.908 ns ±  10.494 ns  ┊ GC (mean ± σ):  0.35% ±  1.51%

  ▂  ▁▃██▆▃                                                    ▂
  █▇▇█████████▆▆▅▅▄▃▆▅▅▆▄▅▁▁▃▁▁▁▁▁▁▁▁▃▁▃▁▃▁▁▁▁▁▁▁▁▁▁▁▁▄▁▁▁▃▅▆▇ █
  41.4 ns       Histogram: log(frequency) by time      51.8 ns &lt;
...
<pre id="plutouiterminal">BenchmarkTools.Trial: 10000 samples with 996 evaluations.
 Range (min … max):  25.550 ns … 576.447 ns  ┊ GC (min … max): 0.00% … 89.21%
 Time  (median):     33.225 ns               ┊ GC (median):    0.00%
 Time  (mean ± σ):   31.886 ns ±  10.535 ns  ┊ GC (mean ± σ):  0.48% ±  1.55%

  ▄▅▅▃                    ▂▆█▄                                 ▂
  █████▇▇▆▆▇▆▆▆▆▇▇▇████████████▇▅▃▄▅▅▆▅▄▁▁▄▁▁▁▁▄▃▃▃▃▃▄▁▁▄▁▁▄▄▅ █
  25.6 ns       Histogram: log(frequency) by time      43.2 ns &lt;
